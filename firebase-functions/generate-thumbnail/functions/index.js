...
exports.generateThumbnail = functions.storage.object().onFinalize(async object => {
  ...
  //   await admin.firestore().collection('eventPostImages').doc(fileName).update({ thumbnail: thumbFileUrl });
  //   // await admin.database().ref(`eventPosts/${eventId}/${fileName}`).update({ thumbnail: thumbFileUrl });
